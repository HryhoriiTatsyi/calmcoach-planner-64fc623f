...
export const generateActionPlan = async (
  ...
  try {
    ...
    const prompt = `
      ...
      1. Назва кроку - Детальний опис кроку (2-3 речення) із конкретними прикладами, практич��ими вправами та посиланнями на дослідження чи наукові факти. Часові рамки: (коли цей крок має бути завершений)
